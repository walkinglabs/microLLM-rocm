...
| Multi-GPU/RCCL | 44/44 | collectives, ranked persistent buckets/equivalence/failure, overlap, package and evidence gates |
| Registered test files | 123 | machine-audited native/Python test sources; package consumers run inside the integration gate |
