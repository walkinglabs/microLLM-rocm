...
| Gate | Result | Scope |
|---|---:|---|
| CPU tests | 151/151 | reference, Qwen/DeepSeek, graph/model/weights, benchmark, PyTorch and optimization-log schemas |
| ASan/UBSan | 149/149 | host code; dynamic binding tests isolated |
