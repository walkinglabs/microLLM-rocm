...
| CPU Debug | 360/360 | host code, CLI, model/graph, benchmark, all three package paths and evidence schemas |
| ASan/UBSan CPU | 358/358 | host lifetime, external Storage and instrumented-package linking |
