...
| `softmax_typed_out_` | FP16/BF16同shape/dtype/device caller输出；FP32 reduction后只舍入output；width≤32 serial，之后64/128/256线程block | `torch.softmax(x,-1)` | FP16 Max≤`5e-4`、BF16≤`4e-3`；边界1/17/32/33/64/65/128/129/1024/4096 | FP32/FP8、dim、shape/device/alias/stride错 |
