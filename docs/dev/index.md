...
19. For FP32/BF16 cache policy and its numerical gates, read the
    [KV-cache dtype guide](kv-cache-dtypes.zh-CN.md).
20. For delayed multi-request serving semantics, read the
    [serving scheduler guide](serving-scheduler.zh-CN.md).
21. For the measured optimization loop, read the
