...
| M4 low precision | in progress | Qwen/DeepSeek four-shape matrices；device-native load；optimizer search saturated；explicit vector benchmark | streaming/mapped load；T=512 |
