...
| M4 low precision | in progress | Qwen/DeepSeek matrices；single-file streaming load；optimizer saturated；T=512 baseline/profile | long-sequence GQA backward；multi-shard preflight |
