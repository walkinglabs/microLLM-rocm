...
| M4 low precision | in progress | BF16 FFN/Attention + immutable plans；固定 inference 4/4 PyTorch rows pass | 长上下文/batch>1；混合训练 |
...
| [10](steps/10-bf16.md) | in progress | BF16 official inference fixed matrix 4/4 PyTorch rows pass | mixed training and broader shapes |
