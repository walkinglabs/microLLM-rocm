...
| M1 serial kernels | planned | parallel CE、RMSNorm、transpose-aware GEMM | trace 中旧热点消失 |
...
| [01](steps/01-parallel-cross-entropy.md) | planned | 并行 CE forward/backward | Qwen train |
| [02](steps/02-transpose-aware-gemm.md) | planned | 无复制 transpose GEMM | Qwen generate/train |
