...
| [104](steps/104-deepseek-cached-score-oracle.md) | score oracle complete; profile pending | T2048 score oracle + current profile | 16条HIP+PyTorch门通过，待当前DeepSeek trace |
