...
| [experiments/371-qwen3-bf16-gate-fp32-reject.md](experiments/371-qwen3-bf16-gate-fp32-reject.md) | 全模型gate-FP32简单校准拒绝 |
| [Qwen3 gate-FP32 reject SVG](assets/qwen3-bf16-gate-fp32-reject.svg) | 五case 4/5与T512反例 |
| [experiments/372-qwen3-bf16-projection-calibration.md](experiments/372-qwen3-bf16-projection-calibration.md) | gate/up/down对称五case选择 |
...
| [experiments/376-qwen3-decode-up-fp32-gate.md](experiments/376-qwen3-decode-up-fp32-gate.md) | 双表示完整shape/oracle/性能决定 |
...
| [experiments/382-qwen3-training-gate-up-audit.md](experiments/382-qwen3-training-gate-up-audit.md) | Qwen3 gate/up梯度与参数全量审计 |
...
| [experiments/385-qwen3-training-multistep-state-audit.md](experiments/385-qwen3-training-multistep-state-audit.md) | Qwen3三步loss/参数/moment联合轨迹 |
