...
| Optimization experiment journal | implemented | experiments through 265; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
| Ranked synchronous gradient buckets | correctness baseline | tiny collectives 36→3, rank diff 0/CPU 1.19e-7/failure pass; wall 1.0037× only | ranked Model-S natural 3-bucket smoke before persistence/overlap |
