...
| Optimization experiment journal | implemented | 110 numbered experiments; same-algorithm exact mode measured | HIP Graph, Radeon and production data-parallel tracks |
