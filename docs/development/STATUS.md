...
| Optimization experiment journal | implemented | experiments through 234; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
