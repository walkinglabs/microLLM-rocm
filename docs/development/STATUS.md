...
|---|---|---|---|
| CPU configuration | smoke-tested | CPU 327/327; full CPU/HIP 511/511 with 3 conditional skips; HIP label 173/173; ASan/UBSan 325/325 | broader compiler/OS CI matrix |
...
| PyTorch correctness oracle | smoke-tested | PyTorch-enabled build 301/301; Tensor/graph/model/optimizer parity plus package and schema gates | broader direct PyTorch ROCm operator matrix |
