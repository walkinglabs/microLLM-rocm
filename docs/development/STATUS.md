...
|---|---|---|---|
| CPU configuration | smoke-tested | full 302/302 configuration includes 211 CPU-labelled and 91 HIP-labelled gates; ASan/UBSan 204/204 | broader compiler/OS CI matrix |
...
| Serving scheduler | smoke-tested | delayed/static/admission paths plus divergent-row decode and empty-row prefill model oracles | token-level slot refill wiring and parallel unequal-position kernels |
...
| Optimization experiment journal | implemented | 94 numbered FP32/BF16/load/training/inference experiments with generated figures, raw evidence and keep/discard/invalid gates | HIP Graph, Radeon and production data-parallel tracks |
