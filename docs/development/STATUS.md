...
| Optimization experiment journal | implemented | 57 numbered FP32/BF16/load/long-context experiments with generated figures, raw evidence and keep/discard gates | HIP Graph, Radeon and production data-parallel tracks |
