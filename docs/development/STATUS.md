...
| Serving scheduler | smoke-tested | S1–S8 through full-value block0 Attention/FFN split | first drift isolated to BF16 FFN output; internal FFN split, Cache and latency |
...
| Optimization experiment journal | implemented | 107 numbered FP32/BF16/load/training/inference experiments with generated figures, raw evidence and keep/discard/invalid gates | HIP Graph, Radeon and production data-parallel tracks |
