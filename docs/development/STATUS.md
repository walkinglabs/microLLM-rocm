...
| Optimization experiment journal | implemented | baseline, seven keep, three discards, two rejected variants, repeated medians/context curves and generated SVGs | continue liveness/prefill/fusion work |
