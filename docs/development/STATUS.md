...
|---|---|---|---|
| CPU configuration | smoke-tested | full 312/312 configuration includes 217 CPU-labelled and 95 HIP-labelled gates; ASan/UBSan 210/210 | broader compiler/OS CI matrix |
