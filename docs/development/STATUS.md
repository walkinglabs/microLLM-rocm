...
| Optimization experiment journal | implemented | experiments through 253; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
