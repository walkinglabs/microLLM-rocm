...
| MI300X precision capabilities | smoke-tested | small+large executed roofline: 4096 FP8 477 TFLOPS, 4.31x FP32/1.42x FP16, 18.25% official peak; FP32 reaches 67.83% | executed INT8 probe, official-model FP8 scale policy and packed INT4 software path |
...
| Optimization experiment journal | implemented | 120 experiments; large-shape FP8 speedup and explicit GPU-reference boundary added | HIP Graph, Radeon and production data-parallel tracks |
