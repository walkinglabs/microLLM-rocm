...
| Optimization experiment journal | implemented | FP32 main track plus BF16 shape/model tracks, eleven keep, six discards and repeated evidence | continue GEMM work and redesign BF16 activation lifetime |
