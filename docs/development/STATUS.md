...
|---|---|---|---|
| CPU configuration | smoke-tested | CPU 326/326; full CPU/HIP 510/510 with 3 conditional skips; HIP label 173/173; ASan/UBSan 324/324 | broader compiler/OS CI matrix |
...
| PyTorch correctness oracle | smoke-tested | PyTorch-enabled build 300/300; Tensor/graph/model/optimizer parity plus package and schema gates | broader direct PyTorch ROCm operator matrix |
