...
|---|---|---|---|
| CPU configuration | smoke-tested | CPU 329/329; full CPU/HIP 514/514 with 3 conditional skips; HIP label 174/174; ASan/UBSan 327/327 | broader compiler/OS CI matrix |
...
| PyTorch correctness oracle | smoke-tested | PyTorch-enabled build 303/303; Tensor/graph/model/optimizer parity plus package and schema gates | broader direct PyTorch ROCm operator matrix |
