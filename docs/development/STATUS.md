...
|---|---|---|---|
| CPU configuration | smoke-tested | CPU 342/342; full CPU/HIP 538/538 with 3 conditional skips; HIP label 184/184; ASan/UBSan 340/340 | broader compiler/OS CI matrix |
...
| PyTorch correctness oracle | smoke-tested | PyTorch-enabled build 316/316; Tensor/graph/model/optimizer parity plus package and schema gates | broader direct PyTorch ROCm operator matrix |
...
| Optimization experiment journal | implemented | experiments through 232; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
| Current B1T1024 inference profile | smoke-tested | four rocprof processes, `(6−1)/5`; GEMM 59.7%/66.8%, softmax 14.8%/9.2%, default online calls zero | exact T1024 QK/PV solution screening |
