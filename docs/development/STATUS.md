...
| Optimization experiment journal | implemented | 112 experiments; Qwen 56-candidate strict search closed | HIP Graph, Radeon and production data-parallel tracks |
