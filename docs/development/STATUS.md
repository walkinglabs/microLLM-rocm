...
|---|---|---|---|
| CPU configuration | smoke-tested | CPU 341/341; full CPU/HIP 537/537 with 3 conditional skips; HIP label 184/184; ASan/UBSan 339/339 | broader compiler/OS CI matrix |
...
| PyTorch correctness oracle | smoke-tested | PyTorch-enabled build 315/315; Tensor/graph/model/optimizer parity plus package and schema gates | broader direct PyTorch ROCm operator matrix |
...
| Optimization experiment journal | implemented | experiments through 230; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
...
| Online Attention model route | implemented, rejected | 36 processes, exact 168/196 native hits, 3.5–57MiB saved; all six prefill ratios 0.761×–0.884× and Qwen Max/RMS up to 0.511/0.112 | closed until RoPE/layout emits BF16 Q/K/V without three casts |
