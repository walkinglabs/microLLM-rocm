...
| Cross-framework alignment | smoke-tested | same-weight tiny Transformer: 45/45 value checkpoints, 39 op and 4 layer timings | Qwen/DeepSeek runners/direct PyTorch ROCm |
