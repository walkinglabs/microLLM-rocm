...
| Optimization experiment journal | implemented | experiments through 266; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
| Ranked Model-S natural buckets | measured correctness baseline | collectives 57→3; 15,586,176 values rank-exact; CPU Max/RMS 0.00627/3.483e-6; reducer median 1.678× but 89.3% CV; training 1.0016× | multi-step cold/steady reducer timing before persistence/overlap |
