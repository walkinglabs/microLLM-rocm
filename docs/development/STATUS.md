...
| Optimization experiment journal | implemented | 111 numbered experiments; Deep strict exact kept, first Qwen candidate discarded | HIP Graph, Radeon and production data-parallel tracks |
