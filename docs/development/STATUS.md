...
| Optimization experiment journal | implemented | experiments through 245; raw evidence, rejection gates and generated SVGs validated in CTest | Radeon and production data-parallel tracks |
| BF16 gate/up weight gradient | operator admitted, model route default-off | CPU/HIP/PyTorch BF16 math; 18 processes: gate/up 1.459×/1.890×, query/KV 0.718×–0.976×; CPU 350/350, ASan/UBSan 348/348, HIP 549/549, PyTorch-enabled 324/324 | official-model A/B and longer training trajectory |
