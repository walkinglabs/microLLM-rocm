...
| Serving scheduler | smoke-tested | S1–S8, top-2, row audit and complete-logit/all-block B1/B2 drift trace | first drift at block0; substage split, length-aware Cache and latency |
...
| Optimization experiment journal | implemented | 106 numbered FP32/BF16/load/training/inference experiments with generated figures, raw evidence and keep/discard/invalid gates | HIP Graph, Radeon and production data-parallel tracks |
