...
|---|---|---|---|
| CPU configuration | smoke-tested | framework-only main configure/build; 154/154 CPU CTest | CI matrix |
...
| Optimization experiment journal | implemented | FP32 main track plus BF16 shape/model tracks, eight keep, six discards and repeated evidence | redesign BF16 activation/weight lifetime and continue prefill work |
