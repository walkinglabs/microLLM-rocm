...
| Optimization experiment journal | implemented | FP32 main track plus BF16 shape/model tracks, fourteen keep, thirteen discards and repeated evidence | redesign GEMM structure/BF16 activation lifetime |
