...
| Serving scheduler | smoke-tested | official S1–S8, opt-in top-2 diagnostics and explicit-offset B2 row/order/duplicate audit | row/copy refuted; full-logit/block error growth, length-aware Cache and latency |
...
| Optimization experiment journal | implemented | 105 numbered FP32/BF16/load/training/inference experiments with generated figures, raw evidence and keep/discard/invalid gates | HIP Graph, Radeon and production data-parallel tracks |
