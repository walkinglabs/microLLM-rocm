...
| Serving scheduler | smoke-tested | S1–S8 through BF16 FFN cast/gate/up/SwiGLU/down full-value split | gate GEMM first drift; algorithm-ID audit, Cache and latency |
...
| Optimization experiment journal | implemented | 109 numbered FP32/BF16/load/training/inference experiments with generated figures, raw evidence and keep/discard/invalid gates | HIP Graph, Radeon and production data-parallel tracks |
