...
| BF16 GEMM/autograd/inference | smoke-tested | transactional FFN + Q/K/V/O, shared QKV cast, immutable plans; pinned inference 4/4 PyTorch BF16 rows pass | long-context/batch>1, tied head, Radeon |
...
| Optimization experiment journal | implemented | 58 numbered FP32/BF16/load/long-context experiments with generated figures, raw evidence and keep/discard gates | HIP Graph, Radeon and production data-parallel tracks |
