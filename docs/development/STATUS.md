...
|---|---|---|---|
| CPU configuration | smoke-tested | framework-only main configure/build; 126/126 CPU CTest | CI matrix |
...
| MI300X precision capabilities | smoke-tested | dedicated gfx942 format gate; FP32/FP16/BF16 hipBLASLt execution and Event speedup | FP8/INT8 probes and packed INT4 software path |
