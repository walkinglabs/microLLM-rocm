...
| Optimization experiment journal | implemented | baseline, six keep, one discard, two rejected variants, raw profiler/JSONL and generated SVGs | execute next measured hotspot and retain failures |
