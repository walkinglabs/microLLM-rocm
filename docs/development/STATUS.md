...
|---|---|---|---|
| CPU configuration | smoke-tested | CPU 325/325; full CPU/HIP 509/509 with 3 conditional skips; HIP label 173/173; ASan/UBSan 323/323 | broader compiler/OS CI matrix |
...
| PyTorch correctness oracle | smoke-tested | PyTorch-enabled build 299/299; Tensor/graph/model/optimizer parity plus package and schema gates | broader direct PyTorch ROCm operator matrix |
