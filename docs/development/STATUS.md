...
| Optimization experiment journal | implemented | 115 experiments; idle-gated bucket Pareto and contaminated-window rejection added | HIP Graph, Radeon and production data-parallel tracks |
