...
|---|---|---|---|
| CPU configuration | smoke-tested | framework-only main configure/build; 156/156 CPU CTest | CI matrix |
...
| Optimization experiment journal | implemented | FP32 main track plus BF16 shape/model tracks, nine keep, six discards and repeated evidence | continue launch/GEMM work and redesign BF16 activation lifetime |
