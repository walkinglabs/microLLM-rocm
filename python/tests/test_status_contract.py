...
def main() -> int:
    ...
    for token in (
        ...
        "CPU 429/429",
        "ASan/UBSan 426/426",
        "PyTorch-enabled CPU 431/431",
        "single-GPU HIP label 213/213",
        ...
        "10/10 PyTorch/pointer rows",
        "PyTorch/raw/C++/Python Event 4.530/4.764/4.815/5.086μs",
        "C++/raw 1.011×",
        "Python/C++ 1.056×",
        "raw/PyTorch 1.052×",
        "no-grad gate improves FP16 wide 1.158×",
        "native ratios at width1024 are 1.026×/0.993×",
        "width4096 FP16/BF16 only 0.795×/0.529×",
        "BF16 width4096 tree256→wave1024 Event/wall 1.687×/1.578×",
        "width4096 FP16/BF16 0.821×/0.804×",
        "Autograd fallthrough only 1.008×/0.998× and removed",
        "Qwen 27 and DeepSeek 31 complete stages",
        "logits Max/RMS 8.01e-5/1.01e-5 and 2.48e-5/4.19e-6",
        "complete BF16 headers reproduce 290/339 tensors",
        "494,032,768/1,777,088,000 parameters",
    ...
    for stale in (
        ...
        "CPU 410/410",
        "ASan/UBSan 407/407",
        "PyTorch-enabled CPU 413/413",
        "single-GPU HIP label 203/203",
        "CPU 415/415",
        "ASan/UBSan 412/412",
        "PyTorch-enabled CPU 416/416",
        "single-GPU HIP label 205/205",
        "single-GPU HIP label 206/206",
        "CPU 416/416",
        "ASan/UBSan 413/413",
        "PyTorch-enabled CPU 417/417",
        "single-GPU HIP label 208/208",
        "CPU 417/417",
        "ASan/UBSan 414/414",
        "PyTorch-enabled CPU 418/418",
        "single-GPU HIP label 209/209",
        "CPU 418/418",
        "ASan/UBSan 415/415",
        "PyTorch-enabled CPU 419/419",
        "single-GPU HIP label 210/210",
        "CPU 420/420",
        "ASan/UBSan 417/417",
        "PyTorch-enabled CPU 421/421",
        "CPU 421/421",
        "ASan/UBSan 418/418",
        "PyTorch-enabled CPU 422/422",
        "single-GPU HIP label 211/211",
        "CPU 426/426",
        "ASan/UBSan 423/423",
        ...
        "PyTorch-enabled CPU 399/399",
        "PyTorch-enabled CPU 400/400",
        "PyTorch-enabled CPU 401/401",
        "PyTorch-enabled CPU 402/402",
        "PyTorch-enabled CPU 403/403",
        "PyTorch-enabled CPU 404/404",
        "PyTorch-enabled CPU 405/405",
        "PyTorch-enabled CPU 406/406",
        "PyTorch-enabled CPU 407/407",
        "PyTorch-enabled CPU 408/408",
        "PyTorch-enabled CPU 409/409",
        "PyTorch-enabled CPU 410/410",
        "PyTorch-enabled CPU 411/411",
        "PyTorch-enabled CPU 412/412",
        ...
        "single-GPU HIP label 202/202",
        "serial width1024/4096 only 0.011×/0.004×",
